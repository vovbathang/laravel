                                        ...
                                        <div class="col-xs-12 col-sm-3 no-margin">
                                            <a href="#" class="thumb-holder">
                                                <img alt="" src="{{ asset('themes/default/assets/images/blank.gif') }}"
                                                     data-echo="{{ asset('themes/default/assets/images/products/product-small-01.jpg') }}"/>
                                            </a>
                                        </div>
                                    </div>
                                </li>
                                ...
                                <li>
                                    <div class="row">
                                        ...
                                        <div class="col-xs-12 col-sm-3 no-margin">
                                            <a href="#" class="thumb-holder">
                                                <img alt="" src="{{ asset('themes/default/assets/images/blank.gif') }}"
                                                     data-echo="{{ asset('themes/default/assets/images/products/product-small-02.jpg') }}"/>
                                            </a>
                                        </div>
                                    </div>
                                </li>
                                ...
                                <li>
                                    <div class="row">
                                        ...
                                        <div class="col-xs-12 col-sm-3 no-margin">
                                            <a href="#" class="thumb-holder">
                                                <img alt="" src="{{ asset('themes/default/assets/images/blank.gif') }}"
                                                     data-echo="{{ asset('themes/default/assets/images/products/product-small-03.jpg') }}"/>
                                            </a>
                                        </div>
                                    </div>
                                </li>
                                ...
                                <li>
                                    <div class="row">
                                        ...
                                        <div class="col-xs-12 col-sm-3 no-margin">
                                            <a href="#" class="thumb-holder">
                                                <img alt="" src="{{ asset('themes/default/assets/images/blank.gif') }}"
                                                     data-echo="{{ asset('themes/default/assets/images/products/product-small-04.jpg') }}"/>
                                            </a>
                                        </div>
                                    </div>
                                ...
                                <li>
                                    <div class="row">
                                        ...
                                        <div class="col-xs-12 col-sm-3 no-margin">
                                            <a href="#" class="thumb-holder">
                                                <img alt="" src="{{ asset('themes/default/assets/images/blank.gif') }}"
                                                     data-echo="{{ asset('themes/default/assets/images/products/product-small-05.jpg') }}"/>
                                            </a>
                                        </div>
                                    </div>
                                </li>
                                ...
                                <li>
                                    <div class="row">
                                        ...
                                        <div class="col-xs-12 col-sm-3 no-margin">
                                            <a href="#" class="thumb-holder">
                                                <img alt="" src="{{ asset('themes/default/assets/images/blank.gif') }}"
                                                     data-echo="{{ asset('themes/default/assets/images/products/product-small-06.jpg') }}"/>
                                            </a>
                                        </div>
                                    </div>
                                </li>
                                ...
                                <li>
                                    <div class="row">
                                        ...
                                        <div class="col-xs-12 col-sm-3 no-margin">
                                            <a href="#" class="thumb-holder">
                                                <img alt="" src="{{ asset('themes/default/assets/images/blank.gif') }}"
                                                     data-echo="{{ asset('themes/default/assets/images/products/product-small-07.jpg') }}"/>
                                            </a>
                                        </div>
                                    </div>
                                </li>
                                ...
                                <li>
                                    <div class="row">
                                        ...
                                        <div class="col-xs-12 col-sm-3 no-margin">
                                            <a href="#" class="thumb-holder">
                                                <img alt="" src="{{ asset('themes/default/assets/images/blank.gif') }}"
                                                     data-echo="{{ asset('themes/default/assets/images/products/product-small-08.jpg') }}"/>
                                            </a>
                                        </div>
                                    </div>
                                </li>
                                ...
                                <li>
                                    <div class="row">
                                        ...
                                        <div class="col-xs-12 col-sm-3 no-margin">
                                            <a href="#" class="thumb-holder">
                                                <img alt="" src="{{ asset('themes/default/assets/images/blank.gif') }}"
                                                     data-echo="{{ asset('themes/default/assets/images/products/product-small-09.jpg') }}"/>
                                            </a>
                                        </div>
